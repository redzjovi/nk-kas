          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                      ...
                      <form class="form-horizontal style-form" action='<?php echo site_url('Kas/proses_edit_kas');?>' method='POST'>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <input type="text" class="form-control" id="disabledInput" name ="status" value="<?php echo $kas->status;?>" readonly>
                              </div>
                          </div>            
                          <div class="form-group">
                              <label class="col-sm-2 col-sm-2 control-label">Date</label>
                              <div class="col-sm-2">
                                  <input type="date" class="form-control" name ="date" value="<?php echo $kas->date;?>" >
                              </div>
                          </div>
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <select class="form-control" name ="jenis_pengeluaran">
                                        <option class="hide"><?php echo $kas->jenis_pengeluaran;?></option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                    <select class="form-control" name ="divisi" value="<?php echo $kas->divisi;?>">
                                        <option class="hide"><?php echo $kas->divisi;?></option>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input type="text" class="form-control" name ="jumlah" value="<?php echo $kas->jumlah;?>">
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <a href="<?php echo site_url('kas');?>"><button class="btn btn-danger">close</button></a></center>
                      </form>
                  </div>
          		</div><!-- col-lg-12-->      	
          	</div><!-- /row -->
