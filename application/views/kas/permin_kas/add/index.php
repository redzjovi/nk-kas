      ...
      <aside>
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      <a class="active" href="<?php echo site_url('Kas/create'); ?>">
          ...
          <section class="wrapper">
          	...
          	<div class="row mt">
                  ...
                  <div class="form-panel">
                  	  <h4 class="mb"><i class="fa fa-angle-right"></i> Pengajuan Permintaan Cash</h4>
                      <form class="form-horizontal style-form" action='<?php echo site_url('Kas/add');?>' method='POST'>
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-3">
                                  <input type="text" class="form-control" name ="jumlah" id="element" required>
                              </div>
                          </div>
                          <div class="form-group">
                          ...
                          <div class="form-group">
                              ...
                              <div class="col-sm-2">
                                  <input type="text" class="form-control" name ="status" value="waiting" readonly>
                              </div>
                          </div>            
