      ...
      *********************************************************************************************************************************************************** -->
	  ...
	  <div id="regis-page">
	  	<div class="container">
		      ...
		      <form class="form-login" action='<?php echo site_url('auth/do_register');?>' method='POST'>
		        <h2 class="form-login-heading">sign up now</h2>
		        <div class="login-wrap">
		            <input type="text" class="form-control" name="nama" placeholder="Nama" required>
		            <br>
                <input type="text" class="form-control" name="username" placeholder="Username" minlength="4" required>
                <br>
                ...
                <br>
		            ...
		            <div class="registration">
		                ...
		                <a class="" href="<?php echo site_url('auth/login'); ?>">
		                    Login
		                </a>
		            </div>
